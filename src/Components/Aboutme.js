...
function Accordian() {
  ...
  return (
    <div>
        <Typography variant='h4' sx={{paddingTop: '10px'}} textAlign={'center'}>About Us</Typography>        
        <hr />
      ...
      <Typography variant='h4' sx={{paddingTop: '10px'}} textAlign={'center'}>Resources that we Provide</Typography>
